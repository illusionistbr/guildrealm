...
Para facilitar a leitura, alguns termos utilizados neste documento têm significados específicos:
...
| **Guild** | Um grupo ou clã criado por usuários dentro da plataforma |
| **Líder** | Usuário responsável pela administração de uma Guild |
| **Conteúdo** | Qualquer material publicado por usuários, incluindo textos, imagens, avatares, banners, comentários, posts, guias, descrições e logos |
...
4. **Atualização**: Mantenha suas informações de contato atualizadas para receber comunicações importantes sobre a plataforma.
...
As seguintes informações podem ser visíveis para outros usuários:

- Nome de usuário (nickname)
- Avatar e banner
- Biografia
- Guilds das quais participa
- Conquistas e badges
- Reputação e ranking
- Data de entrada na plataforma
- Lista de amigos (configurável)
- Comentários e posts publicados
...
- Quem pode ver suas conquistas
- Quem pode enviar convites para guilds
- Visibilidade do seu perfil em buscas

Você pode ajustar estas configurações a qualquer momento através das opções de privacidade da sua conta.
...
Qualquer usuário elegível pode criar uma Guild. A criação de uma Guild exige:

- Um nome único dentro da plataforma
- Uma descrição
- A aceitação das regras da comunidade

O nome da Guild não pode violar as mesmas regras aplicáveis aos nicknames.

### Administração

O líder da Guild possui poderes para:

- Aceitar ou recusar candidaturas
- Remover membros
- Promover ou rebaixar cargos
- Editar informações da Guild
...
Guilds podem publicar vagas e receber candidaturas de usuários. O líder é responsável por:

- Definir critérios de recrutamento
- Comunicar-se de forma respeitosa com candidatos
- Não utilizar meios fraudulentos para atrair membros

### Responsabilidades dos Líderes

O líder de uma Guild é responsável por:

- Garantir que os membros sigam as regras da comunidade
- Moderar o conteúdo publicado em nome da Guild
- Responder por violações cometidas em atividades da Guild
- Manter as informações da Guild atualizadas
...
- Distribuí-lo para outros usuários dentro da plataforma
- Realizar backups para segurança dos dados
- Moderar e revisar o conteúdo para cumprir as regras da comunidade

Se você excluir seu conteúdo da plataforma, a licença será encerrada em um prazo razoável, respeitados os períodos de backup e cache.

### Conteúdo Proibido

Você não pode publicar conteúdo que:

- Infrinja direitos autorais de terceiros
- Contenha material ilegal
- Promova ódio, violência ou discriminação
- Conteúdo pornográfico ilegal ou exploração sexual
- Conteúdo enganoso ou fraudulento
- Malware, links maliciosos ou scripts prejudiciais
- Informações pessoais de terceiros sem autorização
- Spam ou propagandAA não autorizada
...
Os seguintes comportamentos são estritamente proibidos:

- **Spam**: Publicação repetitiva de mensagens, links ou conteúdo irrelevante
- **Bots e Scripts**: Uso de automação não autorizada para interagir com a plataforma
- **Fraudes**: Enganação de outros usuários para obter vantagens indevidas
- **Assédio**: Perseguição, intimidação ou constrangimento de outros usuários
...
- **Doxxing**: Publicação não autorizada de informações pessoais de terceiros
- **Ameaças**: Ameaças de violência física ou digital
- **Manipulação de Rankings**: Qualquer tentativa de fraudar pontuações, rankings ou conquistas
- **Exploração de Bugs**: Uso intencional de falhas da plataforma para obter vantagens. Caso encontre um bug, reporte-o à equipe.
- **Bypass de Moderação**: Tentativa de contornar suspensões, banimentos ou restrições aplicadas pela equipe
- **Contas Alternativas**: Criação de contas para evitar punições aplicadas à conta principal

### Consequências

Violações das regras de conduta podem resultar em:

- Remoção de conteúdo
- Advertência
- Suspensão temporária
- Banimento permanente
- Perda de conquistas, XP e posições em rankings
- Exclusão da conta

A gravidade da penalidade será determinada pela equipe de moderação considerando a reincidência, a intencionalidade e o impacto da violação.
...
- For necessário para investigação de violação dos Termos
...
As conquistas são um sistema de gamificação da plataforma. Elas não possuem valor monetário e não podem ser transferidas, vendidas ou trocadas.
...
- Adicionar ou remover conquistas
- Resetar temporadas
- Ajustar regras de pontuação

Estas alterações são necessárias para:

- Corrigir falhas ou inconsistências
- Prevenir fraudes e manipulações
- Equilibrar a competição entre usuários
- Melhorar a experiência da plataforma

### Integridade

Usuários flagrados manipulando o sistema de conquistas podem perder todas as pontuações acumuladas e sofrer sanções adicionais.
...
Em caso de empate, os critérios de desempate serão definidos por temporada e divulgados na página do ranking correspondente.

### Fraudes

Qualquer tentativa de fraudar rankings resultará em:

- Remoção do ranking
- Perda de pontuações
- Suspensão ou banimento
- Notificação pública quando aplicável
...
Qualquer usuário pode denunciar conteúdo, perfis, guilds ou mensagens que violem estes Termos.

### Como Funciona

1. O usuário envia uma denúncia através dos canais disponíveis na plataforma
2. A denúncia é analisada pela equipe de moderação
3. Se a violação for confirmada, as medidas cabíveis são aplicadas
4. O denunciante pode ou não ser notificado sobre a resolução, conforme o caso

### Boas Práticas

- Denuncie apenas violações reais dos Termos
- Não utilize denúncias como forma de assédio ou retaliação
- Forneça informações claras e completas na denúncia

Denúncias falsas ou abusivas podem resultar em penalidades para o denunciante.
...
Violações leves podem resultar em advertência, que fica registrada no histórico da conta.

### Suspensões

Violações moderadas ou reincidência podem resultar em suspensão temporária. Durante a suspensão, o usuário não pode acessar sua conta.

A duração da suspensão varia conforme a gravidade e a reincidência.

### Banimentos

Violações graves podem resultar em banimento permanente. Contas banidas não podem ser reativadas.

### Direito de Recurso

Usuários que receberem penalidades podem solicitar revisão através dos canais oficiais. O recurso deve conter:

- Identificação da penalidade recebida
...
Usuários que violarem as regras do sorteio ou estes Termos podem ser desclassificados, mesmo após o anúncio do resultado.
...
O layout, a aparência e a experiência da plataforma são protegidos por direitos autorais e leis de propriedade intelectual.
...
Todas as marcas, nomes de jogos, logos e propriedades intelectuais relacionadas a jogos de terceiros pertencem aos seus respectivos proprietários.
...
- Interações entre usuários ocorridas fora da plataforma
- Problemas técnicos em jogos de terceiros
...
A plataforma pode ficar indisponível devido a:

- Manutenções programadas ou emergenciais
- Falhas técnicas em servidores ou infraestrutura
- Ataques cibernéticos e tentativas de invasão
- Atualizações de software
- Problemas com provedores de serviços terceiros
...
- Funcionalidades específicas estarão disponíveis permanentemente
...
3. Custos decorrentes de interrupções do serviço
4. Conteúdo publicado por usuários que viole direitos de terceiros
...
Você pode solicitar a exclusão da sua conta a qualquer momento através das configurações da plataforma ou entrando em contato com a equipe.

Após a solicitação de exclusão:

- Sua conta será desativada dentro de um prazo razoável
- Seu perfil deixará de ser visível publicamente
...
- Você criar múltiplas contas após banimento
...
- Todos os dados associados à conta serão perdidos
- Conquistas, XP, badges e rankings serão removidos
- A reativação não é garantida e depende de análise da equipe
- Licenças de conteúdo serão encerradas dentro de prazos razoáveis
...
1. A versão atualizada será publicada na plataforma
2. A data de vigência será atualizada no início do documento
3. Usuários serão notificados sobre alterações significativas através do e-mail cadastrado ou notificação na plataforma
4. O histórico de versões será mantido ao final do documento
...
- A alteração beneficiar o usuário
...
O uso continuado da plataforma após a vigência das alterações constitui aceitação dos novos Termos.
