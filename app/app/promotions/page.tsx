...
const promotions: Promotion[] = [
  ...
  },
  {
    ...
    partner: 'LagoFast',
    category: 'Otimizador de conexão',
    title: 'Conexão estável, performance máxima',
    description: 'Acelere seu MMORPG favorito e elimine o lag nas batalhas decisivas.',
    discount: '63% OFF anual • 30% OFF mensal',
    image: '/images/clanforge-hero.png',
    href: 'https://www.lagofast.com/en/refer/?cid=8167406',
    badge: 'Parceiro Oficial',
    expiresAt: '',
    coupon: 'clanforge',
    featured: true,
