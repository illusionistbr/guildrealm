...
export default function LoginPage() {
  ...
  const handleDiscord = async () => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : 'Erro ao iniciar login com Discord.');
      ...
      <div className="login-bg">
        ...
        <div className="login-card">
          ...
          <div className="login-socials">
            <button className="login-social-btn" type="button" onClick={handleDiscord} disabled={oauthLoading || !DISCORD_CLIENT_ID} title={DISCORD_CLIENT_ID ? 'Entrar com Discord' : 'Login com Discord indisponível'}>
